...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['altername'])) {
			$data['altername'] = $this->request->post['altername'];
		} elseif (isset($this->request->get['product_id'])) {
			$data['altername'] = $this->model_catalog_product->getProductDescriptions($this->request->get['product_id']);
		} else {
			$data['altername'] = array();
		}
